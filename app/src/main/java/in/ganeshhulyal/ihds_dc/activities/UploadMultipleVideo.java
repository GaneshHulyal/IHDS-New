...
import in.ganeshhulyal.ihds_dc.adapters.MyAdapter;
import in.ganeshhulyal.ihds_dc.others.InternetConnection;
import in.ganeshhulyal.ihds_dc.others.PostData;
import in.ganeshhulyal.ihds_dc.others.SharedPrefsManager;
import in.ganeshhulyal.ihds_dc.utils.FileUtil;
...
public class UploadMultipleVideo extends AppCompatActivity {
    private static final String TAG = UploadMultipleVideo.class.getSimpleName();
        ...
        MaterialDialog mDialog = new MaterialDialog.Builder(this)
                ...
                .setPositiveButton("Yes?", R.drawable.ic_baseline_check_24, new MaterialDialog.OnClickListener() {
                    ...
                    public void onClick(com.shreyaspatil.MaterialDialog.interfaces.DialogInterface dialogInterface, int which) {
                        startActivity(new Intent(UploadMultipleVideo.this, UserCategoryActivity.class));
                        finish();
                    }
                })
                .setNegativeButton("No", R.drawable.ic_baseline_cancel_24, new MaterialDialog.OnClickListener() {
                    @Override
                    public void onClick(com.shreyaspatil.MaterialDialog.interfaces.DialogInterface dialogInterface, int which) {
                        startActivity(new Intent(UploadMultipleVideo.this, UserFeedBackActivity.class));
                        finish();
                    }
                })
                .build();
    ...
    public void  logoutDialogue() {
        ...
        MaterialDialog mDialog = new MaterialDialog.Builder(this)
                ...
                .setPositiveButton("Yes", R.drawable.ic_baseline_check_24, new MaterialDialog.OnClickListener() {
                    @Override
                    public void onClick(com.shreyaspatil.MaterialDialog.interfaces.DialogInterface dialogInterface, int which) {
                        Toast.makeText(UploadMultipleVideo.this, "Logging out", Toast.LENGTH_SHORT).show();
                        sharedPrefsManager.saveStringValue("userEmail", null);
                        sharedPrefsManager.saveBoolValue("isLoggedIn", false);
                        startActivity(new Intent(UploadMultipleVideo.this,UserLoginActivity.class));
                        finish();
                    }
                })
                .setNegativeButton("No", R.drawable.ic_baseline_cancel_24, new MaterialDialog.OnClickListener() {
                ...
                if (resultData != null) {
                    if (resultData.getClipData() != null) {
                        ...
                        if(count>=0){
                            ...
                            Toast.makeText(this, "Select 2 or more Videos", Toast.LENGTH_SHORT).show();
                            btnUpload.setVisibility(View.VISIBLE);
                        ...
                        while (currentItem < count) {
                            ...
                            try {
                                ...
                                MyAdapter mAdapter = new MyAdapter(UploadMultipleVideo.this, arrayList);
    ...
    private void uploadImagesToServer() {
        if (InternetConnection.checkConnection(UploadMultipleVideo.this)) {
            ...
            RequestBody humanCentricAgreement=createPartFromString(sharedPrefsManager.getStringValue("humanAgreementName","Null"));
            ...
            hideProgress();
            Toast.makeText(UploadMultipleVideo.this,
        ...
        if ((ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                Snackbar.make(this.findViewById(android.R.id.content),
                        ...
                        v -> ActivityCompat.requestPermissions(UploadMultipleVideo.this,
                                new String[]{Manifest.permission.READ_EXTERNAL_STORAGE,
                                        Manifest.permission.WRITE_EXTERNAL_STORAGE},
                                REQUEST_CODE_PERMISSIONS)).show();
            } else {
                /* Request for permission */
                ActivityCompat.requestPermissions(UploadMultipleVideo.this,
                        new String[]{Manifest.permission.READ_EXTERNAL_STORAGE,
                                Manifest.permission.WRITE_EXTERNAL_STORAGE},
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_CODE_PERMISSIONS) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                // Permission Denied
                Toast.makeText(UploadMultipleVideo.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
            }
        } else {
    ...
    private void showMessageOKCancel(DialogInterface.OnClickListener okListener) {
        AlertDialog.Builder builder = new AlertDialog.Builder(UploadMultipleVideo.this);
        ...
        dialog.setOnShowListener(arg0 -> {
            dialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(
                    ContextCompat.getColor(UploadMultipleVideo.this, android.R.color.holo_blue_light));
            dialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(
                    ContextCompat.getColor(UploadMultipleVideo.this, android.R.color.holo_red_light));
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(UploadMultipleVideo.this, UserUploadMenuActivity.class));
        finish();
    }
